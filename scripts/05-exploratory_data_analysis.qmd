...
```{r}
linear_model <- lm(pct ~ numeric_grade + pollscore + transparency_score + sample_size + partisan + methodology + population + race_id + stage + nationwide_batch + ranked_choice_reallocated + hypothetical, data = analysis_data)
