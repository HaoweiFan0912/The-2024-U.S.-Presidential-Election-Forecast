...
plots[["Trump"]]<-ggplot(train_Trump, aes(x = numeric_grade, y = pollscore)) +
  ...
  labs(title = "Numeric Grade VS Pollscore in Trump's Training Set",
       x = "Numeric Grade",
       y = "Pollscore")
...
plots[["Harris"]]<-ggplot(train_Harris, aes(x = numeric_grade, y = pollscore)) +
  ...
  labs(title = "Numeric Grade VS Pollscore in Harris's Training Set",
       x = "Numeric Grade",
       y = "Pollscore")
...
```{r,message=FALSE, echo=FALSE,warning=FALSE,fig.height = 5, fig.width=10}
