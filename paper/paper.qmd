...
date: today
date-format: long
abstract: "This study aggregates polling data to forecast 2024 U.S. presidential candidate support for Kamala Harris and Donald Trump. Employing linear models with adjustments, the analysis finds a modest lead for Harris at 47.6% compared to Trump’s 43.5%. The results demonstrate that rigorously weighted polling data enhances forecast stability, offering valuable insights for political and economic decision-makers."
format: pdf
...
# Introduction
The U.S. presidential election has profound implications on a global scale, shaping international relations, economic policy, and key social issues. As the 2024 election approaches, the ability to accurately forecast potential outcomes is essential for policymakers, businesses, and organizations seeking to anticipate shifts in U.S. policy that may affect trade, climate commitments, and strategic alliances (BBC News, 2024). Additionally, recent analyses suggest that the election could introduce volatility into financial markets, emphasizing the importance of reliable predictions for strategic planning (Euronews, 2024). However, predicting election outcomes presents significant challenges due to a multitude of influencing factors, such as media influence, public sentiment, and socio-political dynamics, which collectively add complexity to election forecasting (University of Oregon, 2024). Past elections further illustrate that targeted messaging and political events can profoundly impact voter behavior, complicating predictions even further (Yale University, 2022).
