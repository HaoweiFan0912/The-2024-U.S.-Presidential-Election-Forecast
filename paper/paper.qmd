...
#| echo: false
#### Install packages ####
required_packages <- c("tidyverse","knitr","dplyr","arrow","patchwork","car","kableExtra","gridExtra","moments")
...
variable_descriptions <- data.frame(
  Variable = c(
    "poll_id", "methodology", "population", "ranked_choice_reallocated",
...
#| include: false
catego <- c(
  "poll_id", "pollster_id", "sponsor_ids", "pollster_rating_id", "methodology", "state",
...
del_2 <- c(
  "pollster", "sponsors", "display_name", "pollster_rating_name", "sponsor_candidate", "endorsed_candidate_name",
...
del_4 <- c(
  "endorsed_candidate_id", "endorsed_candidate_party", "subpopulation", "cycle", "election_date", "stage", "nationwide_batch",
...
First, we verified the assumptions mentioned in the @sec-Model_Overview. The @tbl-vohfm shows the General Variance Inflation Factor (GVIF) for both models, which indicates that all predictors have a GVIF less than 1.3, suggesting no significant multicollinearity.
